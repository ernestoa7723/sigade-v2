...
function ListUsers(props) {
    ...
    useEffect(() => {
        const getDataUser = async () => {
            ...
            // TODO get http://127.0.0.1:8080/users/filter
            if (api_connection) {
                response = await axios.get('http://127.0.0.1:8088/users/filter' + query_params)
            } else {
    ...
    const adminSectionTd = (index, user) => {
        if (props.user) {
            return (
                <td>
                    <div className="row row-cols-1 row-cols-lg-2 g-1 m-0">
                        <div className="col text-center">
                            <button type="button" className="btn btn-warning" data-bs-toggle="modal" data-bs-target={'#update-user-modal-'.concat(index)}>
                            ...
                            <ModalUsers id={'update-user-modal-'.concat(index)} obj={user} api_connection={props.api_connection} />
                        </div>
                        <div className="col text-center">
                            ...
                            <ModalDelete id={'delete-user-modal-'.concat(index)} model={'User'} obj={user} api_connection={props.api_connection} />
                        </div>
                    </div>
                </td>
            )
        ...
        return (
            <main className="flex-shrink-0">
                <div className="container p-3 fs-1 text-center">
                    <p>Ups!</p>
                    <p>¯ \ _ (ツ) _ / ¯</p>
                    <p>No hay nada para mostrarte aquí.</p>
                </div>
            </main>
        )
    }
            ...
            <div className="container p-3">
                <div className="row">
                    ...
                    <div className="col-auto ms-auto my-auto">
                        ...
                        <ModalUsers id={'create-user-modal'} obj={null} api_connection={props.api_connection} />
