        ...
        if (this.props.user !== null) {
            return (
                <div className="col-auto px-1 ms-auto my-auto">
                    ...
                    <ModalReport id={'create-report-modal'} obj={null} api_connection={this.props.api_connection} />
                </div>
            )
        }
    }
        ...
        if (this.props.user !== null) {
            return (
                <div className="col text-center">
                    ...
                    <ModalReport id={'update-report-modal-'.concat(index)} obj={report} api_connection={this.props.api_connection} />
                </div>
            )
        }
    }
