...
function FilterSport(props) {
    ...
    useEffect(() => {
        const getDataSport = async () => {
            ...
            // TODO get http://127.0.0.1:8080/sports/filter
            if (api_connection) {
                response = await axios.get('http://127.0.0.1:8088/sports/filter' + query_params)
            } else {
        ...
        if (props.user) {
            return (
                <div className="col-auto px-1 ms-auto my-auto">
                    ...
                    <ModalSport id={'create-sport-modal'} obj={null} api_connection={props.api_connection} />
    ...
    const updateSportModal = (index, sport) => {
        if (props.user) {
            return (
                <div className="col text-center">
                    ...
                    <ModalSport id={'update-sport-modal-'.concat(index)} obj={sport} api_connection={props.api_connection} />
                </div>
            )
        }
    }
        ...
        if (props.user) {
            return (
                <div className="col text-center">
                    ...
                    <ModalDelete id={'delete-sport-modal-'.concat(index)} model={'Sport'} obj={sport} api_connection={props.api_connection} />
                </div>
            )
        }
    }
    ...
    const adminSectionTd = (index, sport) => {
        if (props.user) {
            return (
                <td>
